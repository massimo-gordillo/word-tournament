/*
  # Auto-forfeit configuration

  - Adds app_config.auto_forfeit_consecutive_penalties to control how many
    consecutive missed days (penalty submissions) trigger automatic forfeit.
  - Extends get_app_config() to expose this value to the client.
*/

-- Add configuration column (defaults to 3 consecutive misses)
ALTER TABLE app_config
ADD COLUMN IF NOT EXISTS auto_forfeit_consecutive_penalties integer NOT NULL DEFAULT 3;
...
RETURNS TABLE (
  ...
  auto_forfeit_consecutive_penalties integer,
